<?php
    $servername = "mysql.linco.com.py";
	$username = "lincopy";
	$password = "ble7znO3TAZXgL";
	$db="linco_perfecta";
	...
	if($_SERVER['REQUEST_METHOD'] == "POST"){
        if(!empty($_POST["nombre"])   &&
            ...
            $modelo_saneado   = filter_var($_POST["modelo"], FILTER_SANITIZE_STRING);
            ...
            $sql = "INSERT INTO contactosbmw (nombre, correo, telefono, modelo, mensaje, fecha_contacto) VALUES ('$nombre_saneado', '$correo_saneado', '$telefono_saneado', '$modelo_saneado', '$mensaje_saneado', '$fecha_contacto')";

            if(mysqli_query($conn, $sql)){
                $para      = "david.gonzalez@perfecta.com.py";
                $cabecera  = "From: no-reply@perfecta.com.py\r\n";
                $cabecera .= "MIME-Version: 1.0\r\n";
                $cabecera .= "Content-type: text/html\r\n";
                $asunto    = "[PERFECTA]: Nuevo contacto desde BMW Premium";
                $template     = '
            ...
            <body bgcolor="#FFFFFF">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                ...
                                                <p style="font-size: 14px; color: #6E6E6E; margin-top: 0px; margin-bottom: 7px;"><b style="color: #6E6E6E">Modelo: </b>' . $modelo_saneado . '</p>
                                                <p style="font-size: 14px; color: #6E6E6E; margin-top: 0px; margin-bottom: 7px;"><b style="color: #6E6E6E">Mensaje: </b><br>' . $mensaje_saneado . '</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                ...
                if(mail($para, $asunto, $template, $cabecera)){
                    ...
                    echo "No se pudo enviar su mensaje";
                      ...
                      echo "ERROR: Ocurrió un error al insertar en la base de datos. " . mysqli_error($conn);
        			}
